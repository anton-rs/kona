//! The stateful implementation of the [AttributesBuilder] trait.

use crate::{
    attributes::BuilderError,
    pipeline::{PipelineEncodingError, PipelineError, PipelineErrorKind, PipelineResult},
