...
use crate::types::spans::{RawSpanBatch, SpanBatchTransactions, SpanBatchBits, SpanBatchPayload, SpanBatchPrefix};
...
impl SpanBatch {
    ...
    pub fn to_raw_span_batch(
        ...
        let txs = SpanBatchTransactions::default();
        // let mut txs = Vec::new();
...
mod tests {
    ...
    fn setup_test() -> &[u8] {
        std::include_bytes!("testdata/spanbatch")
    }
