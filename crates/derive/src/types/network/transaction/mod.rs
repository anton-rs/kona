...
pub trait Transaction: core::any::Any + Send + Sync + 'static {
...
impl<S: 'static> dyn Transaction<Signature = S> {
    pub fn __downcast_ref<T: core::any::Any>(&self) -> Option<&T> {
        if core::any::Any::type_id(self) == core::any::TypeId::of::<T>() {
