...
pub enum HintType {
    ...
    L2Code,
    /// A hint that specifies fetching an output root for a given chain ID at the agreed
    /// upon block.
    L2OutputRoot,
    /// A hint that specifies the preimage of the agreed pre-state root.
    AgreedPreState,
...
impl TryFrom<&str> for HintType {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "l2-output" => Ok(Self::L2OutputRoot),
...
impl From<HintType> for &str {
    fn from(value: HintType) -> Self {
        match value {
            ...
            HintType::L2OutputRoot => "l2-output",
