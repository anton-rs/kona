...
pub enum HintType {
    ...
    /// A hint that specifies bulk storage of all the code, state and keys generated by an execution witness.
...
impl TryFrom<&str> for HintType {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "l2-execute-payload-proof" => Ok(Self::L2ExecutePayloadProof),
